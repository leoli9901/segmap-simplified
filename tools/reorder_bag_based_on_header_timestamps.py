#!/usr/bin/python
"""
来自 https://wiki.ros.org/rosbag/Cookbook
1.7 Reorder a Bag File Based on Header Timestamps
Rearranges the messages inside a file to ensure they are played back in the order of their timestamps; 
messages on /tf are played back one second ahead of time to ensure they are available at the time they are referenced.
"""
...
def main(args):
  ...
  move(bagfile, orig) # 将原始bag文件重命名为.orig.bag; move函数由 shutil 模块实现
